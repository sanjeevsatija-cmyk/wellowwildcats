...
const competitions = [
  {
    ...
    seasons: ["Summer 2025/26"], status: "Active", statusGreen: true,
  ...
  },
  {
    ...
    seasons: ["Summer 2025/26", "Winter 2026"], status: "Active + Upcoming", statusGreen: true,
    summary: "Girls Only · Junior Sunday Competition",
    description: "Girls-only junior Sunday competition run through the Eastern Districts Junior Cricket Association. Currently active for Summer 2025/26 with Winter 2026 upcoming.",
    details: ["Sunday competition format", "Summer 2025/26 active", "Winter 2026 upcoming"],
    links: [
      { label: "Summer 2025/26", url: "https://www.playhq.com/cricket-australia/org/wellington-point-cricket-club/df5cb0b2/girls-only-junior-sunday-competition-via-edjca-summer-202526/e7527b89/teams" },
      { label: "Winter 2026", url: "https://www.playhq.com/cricket-australia/org/wellington-point-cricket-club/df5cb0b2/girls-only-junior-sunday-competition-via-edjca-winter-2026/27d0024a/teams" },
    ],
    headerBg: "#142E14", watermarkColor: "rgba(255,255,255,0.07)",
  },
  {
    ...
    seasons: ["Winter 2026"], status: "Active", statusGreen: true,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {competitions.map((comp) => (
              ...
              >
                ...
                <div
                  className="relative flex items-flex-end p-4 overflow-hidden"
                  style={{ background: comp.headerBg, minHeight: 100 }}
                >
                  {/* Watermark text */}
                  <span
                  ...
                  {/* Badge */}
                  <span className={`relative z-10 self-start font-condensed text-[9px] font-bold tracking-[0.12em] uppercase px-2.5 py-1 rounded ${comp.statusGreen ? "bg-emerald-600 text-white" : "bg-amber-500 text-white"}`}>
                    {comp.status}
                  </span>
                </div>
