  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden flex flex-col" style={{ minHeight: "91vh" }}>
        ...
        {/* Glow behind props */}
        <div className="absolute pointer-events-none" style={{ width:580,height:580,borderRadius:"50%",background:"radial-gradient(circle,rgba(201,160,48,.09) 0%,transparent 70%)",top:"50%",left:"68%",transform:"translate(-50%,-50%)",zIndex:1 }} />
        ...
        {/* Content grid */}
        <div className="relative flex-1 w-full max-w-[1240px] mx-auto px-5 md:px-14 py-16 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center" style={{ zIndex:10 }}>

          {/* ── LEFT TEXT ── */}
          <div className="text-center md:text-left" style={{ animation:"slideL 0.9s cubic-bezier(0.22,1,0.36,1) 0.3s both" }}>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center gap-4 md:gap-8 mb-6">
              <div className="flex flex-col items-center flex-shrink-0">
                <Image src="/logo.svg" alt="Wellington Point Wildcats" width={140} height={140} className="w-24 h-24 md:w-32 md:h-32 object-contain drop-shadow-lg" />
              ...
              <h1 className="font-serif text-[clamp(32px,5.5vw,68px)] font-black leading-[1.0] text-white drop-shadow-md">
                Wellington Point<br />
            ...
            {/* Tagline */}
            <p className="text-[15px] md:text-[17px] text-white/70 font-light leading-[1.75] max-w-[520px] mx-auto md:mx-0 mb-8 md:mb-10">
        ...
        <div className="absolute pointer-events-none" style={{ bottom:-2,left:"-5%",width:"110%",height:90,background:"#C9A030",transform:"skewY(-2.5deg)",zIndex:15 }} />
      </section>

      {/* ═══ STATS BAR ══════════════════════════════════════════════ */}
      <div ref={statsRef} className="bg-gold relative" style={{ zIndex:20 }}>
        <div className="max-w-[1240px] mx-auto px-5 md:px-14 py-5 flex justify-around items-center flex-wrap gap-4">
          {[
            ...
            <div key={s.id} className="flex items-center gap-6">
              <div className="text-center">
                <div id={s.id} className="font-serif text-green-deep leading-none" style={{ fontSize:36 }}>0</div>
              ...
              {i < arr.length - 1 && <div style={{ width:1,height:30,background:"rgba(20,46,20,0.2)" }} />}
            </div>
          ))}
        </div>
      </div>
