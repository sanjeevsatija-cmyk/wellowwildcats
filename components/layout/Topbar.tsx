        ...
        <div className="flex gap-5 items-center">
          ...
          <span className="flex items-center gap-3">
            ...
            <a href="https://facebook.com/wellowildcats" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-gold hover:text-gold-bright transition-colors">
          ...
          <a href="mailto:president@wellowildcats.com.au"
            className="text-gold hover:text-gold-bright transition-colors">president@wellowildcats.com.au</a>
        </div>
      </div>
    </div>
  );
